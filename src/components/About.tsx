      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div className="space-y-6">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/15 text-sm uppercase tracking-[0.2em] text-cyan-200 backdrop-blur-sm animate-[slideIn_0.6s_ease-out]">
              <span className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse" />
              Who We Are
            </span>
            <h2 className="text-5xl md:text-6xl font-bold tracking-tight leading-[1.05] animate-[slideIn_0.8s_ease-out]">
            ...
            <p className="text-lg text-gray-200 leading-relaxed animate-[slideIn_1s_ease-out]">
          ...
          <div className="relative animate-[slideIn_1.2s_ease-out]">
            {/* Outer glow */}
            <div className="absolute -inset-4 bg-gradient-to-r from-cyan-400/20 via-purple-500/15 to-amber-300/20 rounded-[28px] blur-3xl animate-[pulse_3s_ease-in-out_infinite]" />
                ...
                {metrics.map((metric, idx) => (
                  ...
                  >
                    ...
                    <div className="relative">
                      <p className="text-xs uppercase tracking-[0.2em] text-gray-300 mb-3 flex items-center gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-cyan-400 to-purple-400 animate-pulse" />
                        {metric.label}
                      </p>
                      <p className="text-4xl font-bold text-white mb-2 transition-all duration-300 group-hover:scale-110">
