...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen flex items-center overflow-hidden bg-[#050816] font-sans">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full opacity-40 grayscale group overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-l from-transparent via-[#050816]/50 to-[#050816]" />
      </div>
      ...
      <div className="absolute -bottom-1/4 -left-1/4 w-[600px] h-[600px] bg-violet-500/10 rounded-full glow-sharp" />
